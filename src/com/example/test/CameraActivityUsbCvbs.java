...
public class CameraActivityUsbCvbs extends Activity implements OnClickListener{
	...
	private class MyCameraActivityCallbackImpl  implements CameraActivityCallback{
		...
		public int getDisplayRotation() {			
			return CameraUtils.getDisplayRotation(CameraActivityUsbCvbs.this);
		}
	...
	private Handler mHandler = new Handler(){
		...
		public void handleMessage(android.os.Message msg) {
			...
			case MSG_FINISH_ACTIVITY:
				CameraActivityUsbCvbs.this.finish();
				break;
