...
public class CommonFileCompareInfos implements Comparable<CommonFileCompareInfos> {
        private  File mFile;
        private int mIndexNum;
        private static final int LIMIT_INDEX_NUM = 10000;

        public CommonFileCompareInfos(File mFile, int mIndexNum) {
                super();
                this.mFile = mFile;
        ...
        public int getAmendedIndexNum() {
                if(GlobalUtil.mAddSize_comon && mIndexNum <= LIMIT_INDEX_NUM/2){
        ...
        @Override
        public int compareTo(CommonFileCompareInfos that) {
                // for descending sort
